    ...
    <div class="panel panel-default" style="margin-right: 10%; margin-left: 10%;">
        ...
        <div class="panel-body">
            ...
            <div style="align-items:baseline">
                    ...
                    <asp:Button ID="Button2" runat="server" class="btn btn-primary center-block" Text="Revisado" OnClick="Button1_Click" />
                ...
                <br />
                    ...
                    <asp:Button ID="Button1" runat="server" class="btn btn-primary center-block" Text="Volver atras" OnClick="Button1_Click1" />
